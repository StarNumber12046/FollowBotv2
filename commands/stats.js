...
module.exports = {
	...
	do: async (message, client, args, Discord) => {
		...
		if (!client.channels.cache.get(origin.channelId)) return message.channel.send("The announcement channel could not be fetched!");
		...
		let statEmbed = new Discord.MessageEmbed()
			.setTitle(`#${client.channels.cache.get(origin.channelId).name} Announcement Statistics`)
